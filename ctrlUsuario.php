        ...
        <div class="container">
            <div class="nav">
                ...
                <ul class="nav-menu" id="nav-menu">
                    ...
                    <li>
                        <a href="iniciarSesion.html" class="btn btn-hover">
        ...
        <div>
            <section id="articulosprincipales">
                ...
                <?php
                    ...
                    case "login":
                    $usuario->validarDatos($_REQUEST['email'],$_REQUEST['contrasena']);
                    break;
                    case "registrar":
                        $usuario->registrarCuenta($_REQUEST['nombre'],$_REQUEST['apellidoMat'],$_REQUEST['apellidoPat'],$_REQUEST['puesto'],$_REQUEST['email'],$_REQUEST['contrasena']);
                        $usuario->iniciarRegistro();
                        break;
                    }
